...
class Preprocessing():
    ...
    def process(self, input0):
        ...
        for sent in input0:
            ...
            sentence = b''.join(sent).decode('utf-8')
            encoded_sent = self.tokenizer.encode(sentence, # Sentence to encode.
...
class TritonPythonModel:
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            out_0 = self.preprocessing.process(in_0.as_numpy())
